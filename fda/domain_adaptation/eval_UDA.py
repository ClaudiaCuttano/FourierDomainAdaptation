...
from fda.utils.func import per_class_iu, fast_hist
from fda.data import CreateTrgDataLoader
...
def eval_single(cfg, model=None, verbose=True, output_file=None):
    targetloader = CreateTrgDataLoader(cfg, set='val')
    ...
    if model is None:
        model = CreateSSLModel(cfg)
        saved_state_dict = torch.load('../../experiments/snapshots/gta52Cityscapes_DeepLab_MobileNet_FDA_0.09/model_100000_0.09.pth')
